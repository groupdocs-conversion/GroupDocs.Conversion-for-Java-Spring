...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-conversion/GroupDocs.Conversion-for-Java-Spring/releases/download/0.0.4/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar conversion-spring-0.0.4.jar configuration.yaml
## Open http://localhost:8080/Conversion/ in your favorite browser.
```
